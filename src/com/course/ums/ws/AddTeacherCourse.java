...
public class AddTeacherCourse extends MyRoute {
    ...
    public Object myHandle(Request request, Response response) throws Exception {
        ...
        if(resultSet.first()) {
            PreparedStatement preparedStatement = DBManager.getConnection().prepareStatement("INSERT INTO teachers_courses(teachers_id,courses_id) VALUES(?,?)", PreparedStatement.RETURN_GENERATED_KEYS);
